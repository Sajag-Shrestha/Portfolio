                ...
                ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <a class="btn btn-danger btn-sm " onclick="return confirm('Do you want to remove this fact??');" href="delete.php?id=<?php echo $data['id']; ?>" role="button">Delete </a>
                    </td>
                  </tr>
                <?php
                }
